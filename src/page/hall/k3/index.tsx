...
export default () => {
  ...
  const back = () =>{
	...
	const showSubmit=()=>{
		...
		Dialog.confirm({
			content: <>
				<div className='k3-confirm-title'>订单确认</div>
				<Divider />
				<div className='k3-confirm-text'>购买活动：{gameData.qishu}</div>
				<div className='k3-confirm-text'>订单总额：{amount*Object.keys(touzhu).length}元</div>
				<div className='k3-confirm-text'>订单内容：
