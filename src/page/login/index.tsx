        ...
        if (response.data.code == 0) {
          ...
          if (values.nameAndPwd == "1") {
            localStorage.setItem(
              "nameAndPwd",
              JSON.stringify({ name: values.name, pwd: values.pwd })
            );
          } else {
  ...
  return (
    <div className="App-main">
      ...
      <div
        ...
        style={{ height: window.innerHeight - 45, background: "#f0f1f6" }}
      >
        <div className="bg" >
          <div className="login-img">
            {website_logo3 == "" ? (
              ...
              <Image lazy height={50} fit="scale-down" src={website_logo3} />
            )}
          </div>
          ...
          >
            ...
            >
              <Checkbox
                defaultChecked={nameAndPwd.pwd == "" ? false : true}
                value="1"
              >
                记住密码
              </Checkbox>
